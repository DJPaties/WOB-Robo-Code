...
#             tts("اِي شِفِتْ دَءْنَكْ  و حَسَبْ ما شايِفْ عِنْدَكْ دَءِنْ حِلْوِة.", "ar-LB")
#         else:
#             print("لاءْ  ما شِفِتْ أِنِّو عِندَكْ دَءِنْ أَصلاً")
#             tts("لاءْ  ما شِفِتْ أِنِّو عِندَكْ دَءِنْ أَصلاً", "ar-LB")
...
def analyze_image(request_from_object):
    ...
    if request_from_object == "FindBeard":
        ...
        if beard_detect:
            ...
            print("لاءْ  ما شِفِتْ أِنِّو عِندَكْ دَءِنْ أَصلاً")
            tts("لاءْ  ما شِفِتْ أِنِّو عِندَكْ دَءِنْ أَصلا", "ar-LB")
