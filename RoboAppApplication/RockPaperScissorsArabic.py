...
def end_game():
    ...
    tts(f" خِلْصِتْ الّلِعبِةْ نَتيجْتَكْ {player_score}. وانا نتِيجْتِ  {robot_score}.")
    exit(0)
...
def determine_winner(player_choice, npc_choice):
    ...
    if player_choice == npc_choice:
        ...
        if npc_choice == "scissors":
            tts("أِنْتَ تْفُوزْ نَءَّيْتْ حَجْرَةْ وأنا نَءَّيْتْ مَءَصْ.")
            player_score+=1
            return "You win!"  
        else:
            tts("أنا ربِحِتْ نَءَّيْتْ مِءَصْ وإِنْتَ نَءَّيْتْ حَجْرَةْ")
            robot_score+=1
            return "NPC wins!"
    elif player_choice == "paper":
        if npc_choice == "scissors":
            tts("أنا ربِحِتْ نَءِّيْتْ وَرْءَةْ وانتَ نَءَّيْتْ مِءَصْ.")
            player_score+=1
            return "NPC win!"  
        else:
            tts("أنتَ رَبِحْتْ نَءَّيْتْ حَجْرَةْ وانتَ نَءَّيْتْ وَرْءَةْ.")
            robot_score+=1
            return "YOU wins!"
        # return "You win!" if npc_choice == "rock" else "NPC wins!"
    elif player_choice == "scissors":
        if npc_choice == "paper":
            tts("أنت ربِحِتْ نَءَّيْتْ وَرْءَى واِنْتَ نَءَّيْتْ مِءَصْ.")
            player_score+=1
            return "You win!"  
        else:
            tts("انا رَبِحِتْ نَءَّيْتْ حَجْرَةْ واِنْتَ نَءَّيْتْ مِءَصْ.")
            robot_score+=1
            return "NPC wins!"
...
print('reset moves')
write_instruction(serialport,"#1P1500#2P1500#3P1500#4P1500#5P1500#6P500#7P1500#8P1500#9P1500#10P1852#11P1500#12P1500#13P2333#14P1500#15P1500#16P1500#17P1500#18P1500#19P1500#20P1500#21P1500#22P1500#23P1500#24P1500#25P1500#26P2500#27P1500#28P1500#29P1500#30P2472#31P1500#32P1500T1000D1000#1P1500#2P1500#3P1500#4P1500#5P1500#6P500#7P1500#8P1500#9P1500#10P1852#11P1500#12P1500#13P2333#14P1500#15P1500#16P1500#17P1500#18P1500#19P1500#20P1500#21P1500#22P1500#23P1500#24P1500#25P1500#26P2500#27P1500#28P1500#29P1500#30P2472#31P1500#32P1500T1000D1000\r\n")
tts("تَع نِلْعَبْ تْلاتْ جَوْلاتْ ")
# time.sleep(2)
time.sleep(2)
