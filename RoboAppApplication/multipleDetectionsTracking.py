...
class BodyTracking:
    ...
    def process_command(self, command):
        if "left hand" in command or 'left' in command:
            self.trackingObject = 'left'
            print("Focus on the left hand.")
        elif "right hand" in command or 'right' in command:
            self.trackingObject = 'right'
            print("Focus on the right hand.")
        elif "head" in command or "eyes" in command or "nose" in command or "mouth" in command:
