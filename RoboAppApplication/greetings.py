    ...
    while True:
        try:
            ...
            if counter == 1:
                ...
                grab_counter +=1
                if close_hand:
                    talking_scenario(5,"any", "#1P2500#2P2500#3P2500#4P2500#5P2500#6P500#7P500#8P1500#9P1430#10P1852#11P1500#12P1500#13P1500#14P1500#15P1500#17P1500#18P1500#19P2500#21P767#22P700#23P700#24P700#25P900#26P2500#27P1667#28P1030#29P1820#30P2192#31P1500#32P1500T500D500\r\n")
                    close_hand = False
