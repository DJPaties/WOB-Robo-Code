    ...
    if isinstance(response1,dict):
        ...
        if response1["intent"] == 'raise_hand':
            ...
            if response1["entities"]["side"] == "right":
                servo_commandr = "#1P2500#2P2432#3P2367#4P2367#5P2400#6P500#7P1500#8P1500#9P1500#10P1852#11P1500#12P1500#13P1500#14P1500#15P1500#16P1500#17P1500#18P1500#19P1500#21P2200#22P2200#23P2200#24P2500#25P2200#26P2500#27P1200#28P1500#29P2251#30P2472#31P1500#32P1500T500D500\r\n"
                # serialSender.Ser(servo_commandr)
                talking_scenario(5,"any",servo_commandr)
                print("Raised Right")
            elif response1["entities"]["side"] == "left":
                servo_commandl = "#1P2333#2P2398#3P2400#4P2367#5P2400#6P500#7P710#8P1460#9P2220#10P1852#11P1500#12P1500#13P1500#14P1500#15P1500#16P1500#17P1500#18P1500#19P1500#21P2200#22P2200#23P2200#24P2500#25P2200#26P2500#27P1500#28P1500#29P1500#30P2472#31P1500#32P1500T500D500\r\n"
                # serialSender.Ser(servo_commandl)
                talking_scenario(5,"any",servo_commandl)
                print("Raised Left")
            else:
                servo_commandb = "#1P2500#2P2500#3P2500#4P2500#5P2500#6P500#7P710#8P1460#9P2200#10P1852#11P1500#12P1500#13P1500#14P1500#15P1500#16P1500#17P1500#18P1500#19P1500#21P2200#22P2200#23P2200#24P2500#25P2200#26P2300#27P1223#28P1500#29P2160#30P2472#31P1500#32P1500T500D500\r\n"
            ...
            tts(response1['text'],"en-US")
            selfie_command = "#1P2500#2P2500#3P2500#4P2500#5P2500#6P500#7P1500#8P1500#9P1500#10P1852#11P1500#12P1500#13P1500#14P1500#15P1500#16P1500#17P1500#18P1500#19P1500#21P600#22P600#23P2200#24P2500#25P600#26P2500#27P2240#28P780#29P1790#30P2482#31P1500#32P1500T500D500\r\n"
            ...
            tts(response1["text"],"en-US")
            greet_command = "#1P2500#2P2500#3P2500#4P2500#5P2500#6P500#7P500#8P1500#9P1430#10P1852#11P1500#12P1500#13P1500#14P1500#15P1500#16P1500#17P1500#18P1500#19P2500#21P1000#22P1100#23P1133#24P1267#25P2200#26P2500#27P1667#28P1030#29P1820#30P2192#31P1500#32P1500T500D500\r\n"
            ...
            tts(response1['text'],"en-US")
            like_command = "#1P1500#2P1500#3P1500#4P1500#5P1500#6P500#7P1500#8P1500#9P1500#10P1852#11P1500#12P1500#13P1500#14P1500#15P1500#16P1500#17P1500#18P1500#19P1500#21P500#22P500#23P500#24P500#25P2200#26P2500#27P1977#28P1167#29P1750#30P2472#31P1500#32P1500T500D500\r\n"
